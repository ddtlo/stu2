...
/**
 * {@link UspFailoverClusterInvoker}
 *
 */
public class FailoverCluster extends AbstractCluster {

    public final static String NAME = "uspFailover";

    @Override
    public <T> AbstractClusterInvoker<T> doJoin(Directory<T> directory) throws RpcException {
        return new UspFailoverClusterInvoker<>(directory);
    }

    @Slf4j
    public static class UspFailoverClusterInvoker<T> extends FailoverClusterInvoker<T> {
